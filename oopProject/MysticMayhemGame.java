...
public class MysticMayhemGame {
	...
	public static void CreateProfile() {
	    ...
	    sc.nextLine();// Consume remainder of last menu
	    ...
	    usernames.put(player1.getUsername(),player1.getUserID());
	    //Log in
	    currentPlayerID = player1.getUserID();
	    BattleMenu();
	}
	...
	public static void BattleMenu() {
		while (true) {
    		...
    		if (com == 1) {
    			...
    			System.out.println("Upgrade Army");
    			continue;
    		}else if (com == 4) {
    			//Log out
    		    currentPlayerID = -1;
    		    ...
    		    // Default case, handle unexpected values of com
    		    System.out.println("Invalid option");
    		    continue;
    		}
	    }
